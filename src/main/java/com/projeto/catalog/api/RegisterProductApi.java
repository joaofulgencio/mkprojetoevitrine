...
public interface RegisterProductApi {
    ...
    ResponseEntity<ProductResponse> execute(@RequestBody ProductRequest productRequest, @PathVariable("sellerId") int sellerId) throws RegisterProductUseCaseExeception;
}
